    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, default='cover.jpg', null=True, upload_to=userauths.models.user_diractory_path)),
                ('image', models.ImageField(blank=True, default='defaule.jpg', null=True, upload_to=userauths.models.user_diractory_path)),
                ('full_name', models.CharField(blank=True, max_length=200, null=True)),
                ('phone', models.CharField(blank=True, max_length=200, null=True)),
                ('gender', models.CharField(choices=[('female', 'Female'), ('male', 'Male')], default='male', max_length=50)),
                ('relationship', models.CharField(choices=[('sigle', 'Sigle'), ('married', 'Married')], default='sigle', max_length=50)),
